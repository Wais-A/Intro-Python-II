...
new_player = Player('Wais', room['outside'])
# Write a loop that:
#
...
while True:
    ...
    print(
        f'You are located at {current_room.name} located at {current_room.description}')
    ...
    if answer == 'n':
        if hasattr(current_room, 'n_to'):
            ...
            print(f'{current_room.name} enter another location')
    elif answer == 's':
